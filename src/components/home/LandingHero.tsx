        ...
        <div className='mt-8 flex flex-col items-center gap-4 w-full'>
          <div className='grid grid-cols-2 gap-4 w-full text-left'>
            {[
              ...
              { step: '4', label: '핵심 표현', desc: '일상 영어 표현 겟' },
            ].map((item) => (
              <div
                key={item.step}
              ...
              >
                <div className='text-mono-label text-muted-foreground'>STEP {item.step}</div>
                <div>
                  <div className='font-medium text-foreground tracking-tight text-base'>{item.label}</div>
